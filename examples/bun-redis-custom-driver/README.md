# Bun + Redis Cache Example

This example demonstrates how to use `hono-universal-cache` with Redis in a Bun environment.
...
- 🔋 **Built-in features** - No need for dotenv, native .env support
- 📦 **Better performance** - Faster HTTP server and module resolution
- 🎯 **TypeScript native** - No build step needed for development
